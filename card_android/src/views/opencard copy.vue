					...
					<div class="lists">
						...
						<div class="list">
							...
							<div class="listr" style="position: relative;">
								...
								<input style="width: 50vw;display: block;background: none;line-height: 40px;"
									v-model="formData.idCardIssueDate" placeholder="请选择证件签发日" type="date">
							</div>
						</div>
						<div class="list" v-if="formData.idNeverExpired != '1'">
							...
							<div class="listr" style="position: relative;">
								...
								<input style="width: 50vw;display: block;background: none;line-height: 40px;"
									v-model="formData.idCardExpDate" placeholder="请选择证件到期日" type="date">
							</div>
						</div>
				...
				<div v-if="temp == 1">
					<div class="zjBox" v-if="formData.type == 'idcard'">
						<div class="idcardBox" style="position: relative;">
							...
							<div
								style="position: absolute;left: 0;right: 0;top: 0;bottom: 0;display: flex;align-items: center;justify-content: center;opacity: 1;">
								<van-uploader name="file" :after-read="afterRead" style="" :max-size="8000 * 1024"
									@oversize="onOversize">
								</van-uploader>
						...
						<div class="idcardBox idcardBoxf" style="position: relative;">
							...
							<div
								...
								<van-uploader :after-read="afterRead1" style="" :max-size="8000 * 1024"
									@oversize="onOversize">
								</van-uploader>
	...
	export default {
		...
		methods: {
			...
			compress(img, Orientation) {
				...
				this.$toast(ndata.length);
				return ndata
			},
			onOversize() {
				console.log(file);
				this.$toast('文件大小不能超过 80kb');
			}
