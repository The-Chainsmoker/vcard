<template>
	<div class="opencard" id="opencard">
		<pheader :title="'设置开机密码'" :back="true"></pheader>
		<!--  -->
		<div class="count">
				<div>
					<div class="jhBox">
						<!-- <div class="list">
							<span class="listl">旧登录密码</span>
							<div class="listr" id="pas3">
								<div id="areaNumber3" style="width: 100%;text-align: right;">
									<div id="numberInput3" diasbled placeholder="请输入6位数字的交易密码" tabIndex="1"
										kbdtype="Alnum" action="/PasswordServlet"
						...
						<div class="list">
							...
							<div class="listr" id="pas1">
								...
								<input onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" v-model="formData.password" placeholder="请输入开机密码" type="text">
							</div>
						</div>
						<div class="list">
							<span class="listl">确认开机密码</span>
							<div class="listr" id="pas2">
								<!-- <div id="areaNumber2" style="width: 100%;text-align: right;">
									<div id="numberInput2" placeholder="请输入6位数字的交易密码" tabIndex="1" kbdtype="Alnum"
								...
								<input onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" v-model="formData.passwordagain" placeholder="请确认开机密码" type="text">
							</div>
						</div>
						<!-- <div class="list">
			...
			<div>
				<!-- <p class="tips" style="padding-left: 5vw;font-size: 12px;color: #999999;margin-bottom: 3vw;">* Tips: 仅当前登录有效</p> -->
			</div>
...
<script>
	...
	export default {
		...
		async mounted() {
			...
			// 	});
			// });
			// $("#numberInput3").click(function() {
			// 	$("#numberInput3").showKBD({
			// 		areaId: "areaNumber2",
			// 		pageId: "opencard",
			// 		maxLen: 6,
			// 		cursor: true,
		...
		methods: {
			...
			async sureSetPwd(){
				...
				this.$toast('密码设置成功')
				localStorage.setItem('openPass',this.formData.passwordagain)
