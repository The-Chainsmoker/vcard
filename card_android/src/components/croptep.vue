<template>
  <div style="height: 100%;display: flex;flex-direction: column;overflow: hidden;">
    ...
    <div style="flex: 1;">
      <vue-cropper style="width: 100vw;height: 100%;" ref="cropper" mode="100% auto" :img="option.img" :outputSize="option.size" :outputType="option.outputType" :fixedNumber="option.fixedNumber" :fixed="option.fixed" :info="true" :full="option.full" :canMove="option.canMove" :canMoveBox="option.canMoveBox" :original="option.original" :autoCrop="option.autoCrop" :autoCropWidth="option.autoCropWidth" :autoCropHeight="option.autoCropHeight" :fixedBox="option.fixedBox" :infoTrue="option.infoTrue" :centerBox="option.centerBox" @realTime="realTime" @imgLoad="imgLoad" @imgMoving="imgMoving"></vue-cropper>
    </div>
