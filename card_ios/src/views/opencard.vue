<template>
	<div class="opencard" id="opencard">
		...
		<div class="count">
				...
				<div class="" v-if="temp == 0">
					<div class="lists">
						...
						<div class="list" @click="showcardnum = true">
							...
							<div class="listr">
								<input readonly="readonly" v-model="formData.cardnum" placeholder="请输入身份证号" type="text">
						...
						<div class="list" @click="showTimerFN('idCardIssueDate')">
							...
							<div class="listr" style="position: relative;">
								...
								<input readonly="readonly"
									style="width: 50vw;display: block;background: none;line-height: 40px;"
					...
					<div class="zjBox" v-if="formData.type == 'idcard'">
						<div class="idcardBox" style="position: relative;">
							...
							<div
								...
								<van-uploader name="file" :after-read="afterRead" style="width: 100%;height: 100%;"
									:max-size="6000 * 1024" @oversize="onOversize">
								</van-uploader>
						...
						<div class="idcardBox idcardBoxf" style="position: relative;">
							...
							<div
								style="position: absolute;left: 0;right: 0;top: 0;bottom: 0;display: flex;align-items: center;justify-content: center;opacity: 0;">
								<van-uploader :after-read="afterRead1" style="width: 100%;height: 100%;"
									:max-size="6000 * 1024" @oversize="onOversize">
								</van-uploader>
							</div>
						</div>
			...
			<div v-else>
				<div class="btn" :class="temp == 2 && canClick?'canClick':'noclick'" @click="nextFn()">
					{{temp == 0?'下一步':''}}
					{{temp == 1?'下一步':''}}
					{{temp == 2?'完成':''}}
					{{temp == 3?'完成':''}}
		...
		<div>
			<van-popup v-model="showTimer" position="bottom">
				<van-datetime-picker v-model="currentDate" type="date" title="选择年月日" :min-date="minDate"
					:max-date="maxDate" :formatter="formatter" @cancel="showTimer = false" @confirm="confirmTime" />
			</van-popup>
